...
cp "$SCRIPT_DIR/favicon.ico"          "$BUILD_DIR/$PKG_NAME/src/py/bbctrl/http/favicon.ico"
cp "$SCRIPT_DIR/rift-icon-192.png"    "$BUILD_DIR/$PKG_NAME/src/py/bbctrl/http/rift-icon-192.png"
cp "$SCRIPT_DIR/rift-icon-512.png"    "$BUILD_DIR/$PKG_NAME/src/py/bbctrl/http/rift-icon-512.png"
